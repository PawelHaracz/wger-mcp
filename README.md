...
> Development has moved to [https://github.com/wger-project/mcp-server](https://github.com/wger-project/mcp-server).
> Please use that repository for the latest updates and contributions.
